    ...
    <main className="flex flex-col items-center justify-center min-h-full px-4 py-12">
      <div className="w-full max-w-xl">
        ...
        <div className="flex flex-wrap justify-center gap-2 mt-5">
          {[
            { icon: "M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z", label: "38 audits mapped to Next.js" },
            { icon: "M13 10V3L4 14h7v7l9-11h-7z", label: "AI action plan (BYOK)" },
            { icon: "M4 7v10c0 2 1 3 3 3h10c2 0 3-1 3-3V7c0-2-1-3-3-3H7C5 4 4 5 4 7z", label: "Results cached 24h" },
          ].map(({ icon, label }) => (
            <div key={label} className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full glass text-xs text-[var(--text-2)]">
        ...
        {/* Footer */}
        <div className="flex items-center justify-between mt-8 text-xs text-[var(--text-2)] opacity-60">
          <span>5 audits / hour per IP</span>
          <a
